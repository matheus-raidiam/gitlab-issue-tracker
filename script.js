...
const I18N = {
  en: {
    ...
    intro: "This page pulls issues from the Open Finance GitLab project and gives a quick view of SLA risk, activity, and context. Use filters, sorting, and local notes to faster triage.",
    view: "View:",
    from: "From",
    to: "To",
  ...
  pt: {
    ...
    'from': 'De',
    title: "Open Finance Brasil - GitLab Issues",
    intro: "Esta página consulta issues do Open Finance Brasil no GitLab e oferece uma visão de SLA, atividade e contexto. Use filtros, ordenação e notas locais para uma triagem mais rápida.",
    view: "Ver:",
    from: "De",
    to: "Até",
